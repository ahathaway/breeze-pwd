...
class Breeze_Admin {
	public function __construct() {
		...
		// Add our custom action to track all items with password at save
		add_action( 'save_post', array( $this, 'breeze_add_action_save_pw_post' ), 9, 3 );
	...
	function register_menu_page() {
		...
		add_submenu_page( 'options-general.php', __( 'Breeze', 'breeze' ), __( 'Breeze', 'breeze' ), 'manage_options', 'breeze', array(
			$this,
			'breeze_load_page'
		) );
	}
	...
	function register_network_menu_page() {
		...
		add_submenu_page( 'settings.php', __( 'Breeze', 'breeze' ), __( 'Breeze', 'breeze' ), 'manage_options', 'breeze', array(
			$this,
			'breeze_load_page'
		) );
	}
	...
	function breeze_add_action_save_pw_post( $post_id, $post, $update ) {
